...
import { getStocks, subscribeToPriceChanges, getLogoUrl, simulatePriceChange } from '../lib/stockData';
...
export default function Home() {
  ...
  // Initial Data Subscription & Simulation Loop
  useEffect(() => {
    ...
    // 2. Start Simulation Loop (update every 3 seconds)
